...
OWNER_USERNAME = getenv("OWNER_USERNAME","ll_BABUL_ll")
BOT_USERNAME = getenv("BOT_USERNAME" , "babulmusicxbot")
BOT_NAME = getenv("BOT_NAME" , "˹ʙᴀʙᴜʟ ✗ ᴍᴜsɪᴄ˼ ♪ [ ɴᴏ ᴀᴅs ]™")
ASSUSERNAME = getenv("ASSUSERNAME" , "˹ʙᴀʙᴜʟ ✗ ᴍɪsǫᴜᴇᴇɴ ˼ 𝅘𝅥𝅮")
BASE_URL = getenv("BASE_URL", "https://api.babiesiq.tech")
API_KEY = getenv("API_KEY", "BABYXF_02156F967EDCD91CA1D6D0B9CDF68AE2B7CDB871")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BABULXMUSIC905/BABUL-MUSIC",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None) or getenv("GITHUB_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/BOT_BABUL") 
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/QueenSupportChatBot")
SOURCE = getenv("SOURCE", "https://t.me/ll_BABUL_ll")
CHAT = getenv("CHAT", "")
